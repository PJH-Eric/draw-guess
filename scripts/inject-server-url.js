 ...
 *
 * 用法：
 *   GAME_SERVER_URL=https://draw-guess.example node scripts/inject-server-url.js
 *   node scripts/inject-server-url.js https://draw-guess.example
 *   node scripts/inject-server-url.js --allow-local http://localhost:3030   （本機測試）
